#sdp
![[Pasted image 20250429202919.png]]
...
![[Pasted image 20250429202958.png]]
...
- See [Disadvantage(s): replication](https://github.com/donnemartin/system-design-primer?tab=readme-ov-file#disadvantages-replication) for points related to **both** master-slave and master-master.

#### Master-master replication

Both masters serve reads and writes and coordinate with each other on writes. If either master goes down, the system can continue to operate with both reads and writes.

![[Pasted image 20250429203015.png]]
...
![[Pasted image 20250429203052.png]]
...
![[Pasted image 20250429203107.png]]
...
- [Denormalize](https://github.com/donnemartin/system-design-primer?tab=readme-ov-file#denormalization) where performance demands it.
...
![[Pasted image 20250429203127.png]]
...
![[Pasted image 20250429203142.png]]
...
![[Pasted image 20250429203159.png]]
...
- [What happens when databases crash mid backend request?](https://medium.com/p/38c26429dc6e)
- [How to design a Read Heavy system ? Some strategies and best practices](https://medium.com/p/20e416a77cfd)
- [Understanding key storage systems.. (Block, File and Object storage)](https://medium.com/p/83ecb131590f)
- [Cassandra Internals — SSTables : The secret sauce that makes cassandra super fast](https://medium.com/p/3d5badac8eaf)
- [An overview of LSM databases : The new normal for write heavy workloads](https://medium.com/p/dc14a3d05d0b)
- [Cassandra- But why?: Benefits of a columnar DB](https://medium.com/p/f519fc5c9fa9)
- [Database Scaling Basics Explained](https://medium.com/p/81fb165dbf25)
- [Scaling Elasticsearch For Multi-Million Writes and Reads](https://medium.com/p/05c7144a5e40)

- [Internal Working of ElasticSearch : Deep Dive](https://medium.com/p/34a87bbf0404)

- [Use of B-Trees and LSM (Log-Structured Merge) trees in different database architectures](https://medium.com/p/dbc98165d87e)
- [Indexing is about elimination](https://medium.com/p/0ebaf4225a64)
- [SSTable database or big ideas behind the scene](https://medium.com/p/1d449a12fb44)
- [Interview: So, how do you do a Transaction with NoSQL Databases?](https://medium.com/p/c3d80bc7d314)
- [Database Pages — A deep dive](https://medium.com/p/38cdb2c79eb5)
- [NoSQL Databases Explained: All Types & When to Use Them](https://medium.com/p/e90528a3ee91)
- [How Elasticsearch Works](https://medium.com/p/1ebc4aa8dbc0)
- [A basic question in security Interview: How do you store passwords in the database?](https://medium.com/p/676c125cff64)
